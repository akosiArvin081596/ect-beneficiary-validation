...
const form = useForm({
    ...
    father_birth_date: b.father_birth_date
        ? b.father_birth_date.substring(0, 10)
        : '',
    ...
    mother_birth_date: b.mother_birth_date
        ? b.mother_birth_date.substring(0, 10)
        : '',
    ...
    spouse_birth_date: b.spouse_birth_date
        ? b.spouse_birth_date.substring(0, 10)
        : '',
...
<template>
    <Head
        :title="`Edit — ${beneficiary.last_name}, ${beneficiary.first_name}`"
    />
            ...
            <form @submit.prevent="submit" class="space-y-6">
                        ...
                        >
                            <div class="space-y-1">
                                ...
                                <select
                                    ...
                                    v-model="
                                        form.classify_extent_of_damaged_house
                                    "
                                    :class="selectClass"
                                >
                                    <option value="" disabled>Select...</option>
                                    ...
                                    <option
                                        value="Partially Damaged (Slightly)"
                                    >
                            ...
                            <div class="flex flex-wrap gap-4">
                                ...
                                >
                                    <input
                                        ...
                                        :value="sector"
                                        :checked="
                                            form.applicable_sector.includes(
                                                sector,
                                            )
                                        "
                    ...
                    <CardContent class="space-y-4">
                        ...
                        >
                            ...
                            <div class="space-y-1">
                                ...
                                />
                                <InputError
                                    :message="err('father_middle_name')"
                                />
                            </div>
                            <div class="space-y-1">
                                <Label for="father_extension_name"
                                    >Extension</Label
                                >
                                <Input
                    ...
                    <CardContent class="space-y-4">
                        ...
                        >
                            ...
                            <div class="space-y-1">
                                ...
                                />
                                <InputError
                                    :message="err('mother_middle_name')"
                                />
                            </div>
                            <div class="space-y-1">
                    ...
                    <CardContent class="space-y-4">
                        ...
                        >
                            ...
                            <div class="space-y-1">
                                ...
                                />
                                <InputError
                                    :message="err('spouse_middle_name')"
                                />
                            </div>
                            <div class="space-y-1">
                ...
                <Card>
                    ...
                    <CardContent class="space-y-4">
                        ...
                        <div
                            v-if="form.living_with_relatives"
                            class="space-y-4"
                        >
                            <div class="w-32 space-y-1">
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        ...
                        {{ beneficiary.first_name }}? This record will be moved
